...
void	case_for_four(t_list **stack_a, t_list **stack_b)
{
	int i;
...
void	special_case(t_list **stack_a, t_list **stack_b, int i)
{
	...
	if (i == 3)
		case_for_three(stack_a, 0);
	if (i == 4)
		case_for_four(stack_a, stack_b);
	if (i == 5)
		case_for_five(stack_a, stack_b, 0);
}